...
namespace PHYSICAPP {
    ...
    public partial class dsDatos : global::System.Data.DataSet {
        ...
        public partial class LoginDataTable : global::System.Data.TypedTableBase<LoginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LoginRow AddLoginRow(int IdRol, string Nombre, string Apellidos, string Email, string Password, bool Activo) {
...
namespace PHYSICAPP.dsDatosTableAdapters {
    ...
    public partial class LoginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Usuario] ([IdRol], [Nombre], [Apellidos], [Email], [Password], [Acti" +
                "vo]) VALUES (@IdRol, @Nombre, @Apellidos, @Email, @Password, @Activo)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Usuario] SET [IdRol] = @IdRol, [Nombre] = @Nombre, [Apellidos] = @Apellid" +
                "os, [Email] = @Email, [Password] = @Password, [Activo] = @Activo WHERE (([IdUsua" +
                "rio] = @Original_IdUsuario))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["PhysicAppConnectionString"].ConnectionString;
        }
        ...
        public virtual int Insert(int IdRol, string Nombre, string Apellidos, string Email, string Password, bool Activo) {
        ...
        public virtual int Update(int IdRol, string Nombre, string Apellidos, string Email, string Password, bool Activo, int Original_IdUsuario) {
